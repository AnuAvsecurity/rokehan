...
<?php echo $op_config->get('pc_html_head') ?>
    ...
    <!-- Le styles -->
    <link href="/rokehan/web/assets/bootstrap.css" rel="stylesheet">
    <style type="text/css">
      body {
   ...
   <link href='http://fonts.googleapis.com/css?family=Open+Sans' rel='stylesheet' type='text/css'>
    ...
    <link href="/rokehan/web/assets/bootstrap-responsive.css" rel="stylesheet">
...
<?php echo $op_config->get('pc_html_bottom') ?>
    ...
    <script src="/rokehan/web/assets/bootstrap.js"></script>
    <script src="/rokehan/web/assets/bootstrap-transition.js"></script>
    <script src="/rokehan/web/assets/bootstrap-alert.js"></script>
    <script src="/rokehan/web/assets/bootstrap-modal.js"></script>
    <script src="/rokehan/web/assets/bootstrap-dropdown.js"></script>
    <script src="/rokehan/web/assets/bootstrap-scrollspy.js"></script>
    <script src="/rokehan/web/assets/bootstrap-tab.js"></script>
    <script src="/rokehan/web/assets/bootstrap-tooltip.js"></script>
    <script src="/rokehan/web/assets/bootstrap-popover.js"></script>
    <script src="/rokehan/web/assets/bootstrap-button.js"></script>
    <script src="/rokehan/web/assets/bootstrap-collapse.js"></script>
    <script src="/rokehan/web/assets/bootstrap-carousel.js"></script>
    <script src="/rokehan/web/assets/bootstrap-typeahead.js"></script>
