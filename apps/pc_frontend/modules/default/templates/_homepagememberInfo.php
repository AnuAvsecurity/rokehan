...
<div class="message_main mt20">
    ...
    <table width="673" border="0" class="table_li">
        <tr class="m_table_tr">
            ...
            <!--▲削除▲-->
            <!--▽タグ▽-->
            <td class="m_table_td2" width="58"
                onclick="location.href='http://test.s-share.net/mypage/message/message_main/'"><img
                    src="/rokehan/web/assets/images/control/message_nego.png" width="58" height="40" alt="条件交渉"/></td>
            <!--△タグ△-->
            <!--▼ユーザ名▼-->
            <td class="m_table_td2 text_center" width="150"
                onclick="location.href='http://test.s-share.net/mypage/message/message_main/'"><img
                    src="/rokehan/web/assets/images/control/message_lender.png" width="119" height="20" alt="レンダー"/><br/>
                ddddddd
            </td>
            <!--▲ユーザ名▲-->
            <!--▽メール▽-->
            <td class="m_table_td2" width="23"
                onclick="location.href='http://test.s-share.net/mypage/message/message_main/'"><img
                    src="/rokehan/web/assets/images/control/mail_new_icon.png" width="23" height="17" alt="未読"/></td>
            <!--△メール△-->
            <!--▼受信タイトル▼-->
            <td class="m_table_td2 text_center" width="258"
                onclick="location.href='http://test.s-share.net/mypage/message/message_main/'"> オフィスシェアしませんか.....
            </td>
            <!--▲受信タイトル▲-->
            <!--▽受信日時▽-->
            <td class="m_table_td2 text_center" width="120"
                onclick="location.href='http://test.s-share.net/mypage/message/message_main/'"> 13-02-04 20:00
            </td>
            <!--△受信日時△-->
            <!--▼添付▼-->
            <td class="m_table_td2" width="24"
                onclick="location.href='http://test.s-share.net/mypage/message/message_main/'"><img
                    src="/rokehan/web/assets/images/control/clip_icon.png" width="24" height="25"/></td>
            <!--▲添付▲-->
        </tr>
    ...
    <table width="673" border="0" class="table_setsumei mt30">
        <tr>
            <td>【アイコンの説明】</td>
            <td><img src="/rokehan/web/assets/images/control/mail_new_icon.png" width="23" height="17" alt="未読"/></td>
            <td>・・・未読</td>
            <td><img src="/rokehan/web/assets/images/control/mail_back_icon.png" width="23" height="24" alt="既読"/></td>
            <td>・・・既読</td>
            <td><img src="/rokehan/web/assets/images/control/clip_icon.png" width="24" height="25" alt="添付あり"/></td>
            <td>・・・添付あり</td>
        </tr>
    </table>
